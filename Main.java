...
/*	public static void main(String[] args) {
		...
		String[] a={"xy","ab","ab","b","a"};
		String[] a2={"abc","ab","xy","xyx"};
		WordLinkedList w=new WordLinkedList(a);
		WordLinkedList w2=new WordLinkedList(a2);
		//WordLinkedList w=new WordLinkedList();
		...
		System.out.println("**************");
		//System.out.println(w.getWordAt(6));
		//w.insert("ac");
		w.mergeTo(w2);
